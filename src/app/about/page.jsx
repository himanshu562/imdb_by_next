export default function About(){
    return(    //       max-w-6xl is used to give space from right side of 6xl and mx-auto is used to move text in center and p is padding and space-y-5 is used to givespace in row of 5px and text-2xl is used font size of an element and font-medium is used to color(weight) of text yaha pe medium hoga//
